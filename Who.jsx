    ...
    <section id="contact" className="contact">
      <div ref={ref} className={`container reveal ${visible ? 'is-visible' : ''}`}>
        ...
        <p className="contact-sub">
          Whether you are working on a hire, thinking about a move, or simply
          want to understand what is happening in the market, we are worth
          talking to.
        </p>

        <div className="contact-links">
          <a href="mailto:hello@zentiertalent.com" className="contact-link">
            hello@zentiertalent.com
          </a>
          <span className="contact-divider">/</span>
          <a
            href="https://linkedin.com/company/zentier"

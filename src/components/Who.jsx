  ...
  return (
    <section id="who" className="who">
      <div ref={ref} className={`container reveal ${visible ? 'is-visible' : ''}`}>
        ...
        <h2 className="section-title">Three distinct markets.<br /><em>One deep specialism.</em></h2>
        <div className="who-grid">
          <div className="who-card">
            ...
            <div className="who-body">From Magic Circle to boutique, firms building internal AI capability, governance functions, and innovation teams that require people who understand both the law and the technology transforming it.</div>
          </div>
          <div className="who-card">
            <svg className="who-icon" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div className="who-body">Vendors, platforms, and tools competing for the small number of people who can translate between the product and the market it serves.</div>
          </div>
          <div className="who-card">
            <svg className="who-icon" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div className="who-body">Early-stage teams that need commercial, product, and technical hires who understand the legal buyer and the workflow they are selling into.</div>
          </div>
        </div>
      </div>
    </section>
